...
<script charset="utf-8" src="../fuwenben/plugins/code/prettify.js"></script>
	...
	<script>
		KindEditor.ready(function(K) {
			var editor1 = K.create('textarea[name="userMark"]', {
...
var url;
	...
	function formatType(shujuType1, row) {  
		if(shujuType1==0){
			return "申请";
		}
		if(shujuType1==1){
	...
	function chakanNeirong(userId, row) {
		return '<a style="color:red;"target="_blank" href="<%=basePath%>neirong/userneirong.jsp?userId=' + userId + '">查看' + '</a>';  
	}
</script>
</head>
...
<!--startprint-->
	 ...
	 pagination="true" url="../getUsers?userId=<%=userId %>" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="userId" width="10" formatter="chakanNeirong">查看</th>
				...
				<th field="userImg" width="20" formatter="formatChakan">照片</th>
				<th field="userType" width="10" formatter="formatType">状态</th>
	...
	<div id="tb">
		<div>
			...
			<a href="javascript:shangchuanUser()" class="easyui-linkbutton" iconCls="icon-add" plain="true">上传照片</a>
		</div>
	</div>
<!--endprint-->
	<div id="dlg" class="easyui-dialog" style="width: 850px;height: 420px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td valign="top">描述：</td>
					<td colspan="4"><textarea name="userMark" id="userMark" cols="100" rows="12" style="width:700px;height:250px;visibility:hidden;"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
