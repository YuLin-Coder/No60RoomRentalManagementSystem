...
<title><%=newJcpeizhi.getUserBieming()%>注册</title>
...
<style>
body{background: #C7EDCC url(<%=basePath%>shouye/image/shouye.jpg) 50% 0 no-repeat;margin:0;padding:0;}
#login{width:420px;height:460px;position:absolute;left:50%;top:30%;font-size:12px;line-height:24px;margin:-222px auto auto -210px;background:#fbfbfb;}
...
<body>
<div id="login">
        <div class="logo"><%=newJcpeizhi.getUserBieming()%>注册</div>
        <div class="main">
            ...
            <ul>
                ...
                <li>联系人：<input class="wa" type="text" name="userXingming" id="userXingming"/></li>
