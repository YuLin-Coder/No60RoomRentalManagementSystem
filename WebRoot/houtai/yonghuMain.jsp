				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
				  <li class="layui-nav-item layui-nav-itemed">
				    ...
				    <dl class="layui-nav-child">
				      <dd><a href="javascript:;" data-url="<%=basePath%>yonghu/yonghu.jsp" data-id='1' data-text="个人信息"><span class="l-line"></span>个人信息</a></dd>
				      <dd><a href="javascript:;" data-url="<%=basePath%>yonghu/yonghumima.jsp" data-id='2' data-text="修改密码"><span class="l-line"></span>修改密码</a></dd>
				    </dl>
				  </li>
				  <%for(int i = 0; i < jcbiaotis.size(); i++){ %>
				  <li class="layui-nav-item">
				    <a href="javascript:;"><i class="iconfont">&#xe608;</i><%=jcbiaotis.get(i).getJcbiaotiName() %></a>
				    <dl class="layui-nav-child">
				      <%for(int j = 0; j < jcdaohangslist.get(i).size(); j++){ %>
				      <dd><a href="javascript:;" data-url="<%=basePath%>yonghu/<%=jcdaohangslist.get(i).get(j).getJcdaohangNeirong() %>" data-id='<%=i+1 %><%=j %>' data-text="<%=jcdaohangslist.get(i).get(j).getJcdaohangName() %>">
				      <span class="l-line"></span><%=jcdaohangslist.get(i).get(j).getJcdaohangName() %></a></dd>
				      <%} %>
				    </dl>
				  </li>
				  <%} %>
			...
			<div class="main-layout-container">
				...
				<div class="main-layout-header">
					...
					<ul class="layui-nav" lay-filter="rightNav">
					  ...
					  <li class="layui-nav-item">
					    <a href="javascript:;" data-url="<%=basePath%>yonghu/yonghumima.jsp" data-id='5' data-text="修改密码">修改密码</a>
					  </li>
