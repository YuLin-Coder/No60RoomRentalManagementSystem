				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
				  <li class="layui-nav-item layui-nav-itemed">
				    ...
				    <dl class="layui-nav-child">
				      <dd><a href="javascript:;" data-url="<%=basePath%>admin/rizhi.jsp" data-id='1' data-text="登录日志"><span class="l-line"></span>登录日志</a></dd>
				      <dd><a href="javascript:;" data-url="<%=basePath%>admin/adminmima.jsp" data-id='2' data-text="修改密码"><span class="l-line"></span>修改密码</a></dd>
				    </dl>
				  </li>
				  ...
				  <li class="layui-nav-item">
				    ...
				    <dl class="layui-nav-child">
				      ...
				      <dd><a href="javascript:;" data-url="<%=basePath%>admin/<%=jcdaohangslist.get(i).get(j).getJcdaohangNeirong() %>" data-id='<%=i+1 %><%=j %>' data-text="<%=jcdaohangslist.get(i).get(j).getJcdaohangName() %>">
			...
			<div class="main-layout-container">
				...
				<div class="main-layout-header">
					...
					<ul class="layui-nav" lay-filter="rightNav">
					  ...
					  <li class="layui-nav-item">
					    <a href="javascript:;" data-url="<%=basePath%>admin/adminmima.jsp" data-id='5' data-text="修改密码">修改密码</a>
					  </li>
