				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
				  ...
				  <li class="layui-nav-item">
				    ...
				    <dl class="layui-nav-child">
				      ...
				      <dd><a href="javascript:;" data-url="<%=basePath%>user/<%=jcdaohangslist.get(i).get(j).getJcdaohangNeirong() %>" data-id='<%=i+1 %><%=j %>' data-text="<%=jcdaohangslist.get(i).get(j).getJcdaohangName() %>">
