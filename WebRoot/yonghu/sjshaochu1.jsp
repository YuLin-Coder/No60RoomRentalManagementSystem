...
<!--startprint-->
	<table id="dg" title="<%=newJcpeizhi.getShujuBieming()%><%=newJcpeizhi.getSjshaochuBieming()%>" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSjshaochus?sjshaochuType=1&yonghuId=<%=yonghuId %>" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			...
			<a href="javascript:quxiaoSjshaochu()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">退租</a>
		</div>
		<div>
