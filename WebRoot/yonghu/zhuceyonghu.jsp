...
<title><%=newJcpeizhi.getYonghuBieming()%>注册</title>
...
<body>
<div id="login">
        <div class="logo"><%=newJcpeizhi.getYonghuBieming()%>注册</div>
        <div class="main">
            ...
            <ul>
                ...
                <li>身份证：<input class="wa" type="text" name="yonghuMark" id="yonghuMark"/></li>
