...
var url;
	...
	function jujueUser(){
		...
		$.messager.confirm("系统提示","您确认要执行吗？",function(r){
			if(r){
				$.post(url,{userType:0},function(result){
					if(result.errorMsg){
						$.messager.alert("系统提示",result.errorMsg);
						$("#dg").datagrid("reload");
					}else{
...
<!--startprint-->
	...
	<div id="tb">
		<div>
			<a href="javascript:tongguoUser()" class="easyui-linkbutton" iconCls="icon-add" plain="true">通过</a>
			<a href="javascript:jujueUser()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">停用</a>
