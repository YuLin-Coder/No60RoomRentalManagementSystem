...
<!--startprint-->
	<table id="dg" title="<%=newJcpeizhi.getYonghuBieming()%><%=newJcpeizhi.getYyijianBieming()%>" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getYyijians" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			<a href="javascript:openYyijianModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">回复</a>
		</div>
	</div>
<!--endprint-->
	...
	<div id="dlg" class="easyui-dialog" style="width: 380px;height: 220px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table>
				<tr>
					<td valign="top">回复：</td>
					<td><textarea rows="7" cols="30" name="yyijianMark1" id="yyijianMark1"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
