...
public interface ShujuMapper {
     ...
     * @mbggenerated
     */
	List<Shuju> selectBiaoqian(@Param("buyuanNameList") List<String> buyuanNameList,@Param("page")int page,@Param("rows")int rows, @Param("sdate")String sdate, @Param("edate")String edate, @Param("sdate1")String sdate1, @Param("edate1")String edate1);
}